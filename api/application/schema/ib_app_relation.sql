...
--
-- 資料表結構 `ib_app_relation`
--

DROP TABLE IF EXISTS `ib_app_relation`;
CREATE TABLE IF NOT EXISTS `ib_app_relation` (
  `ib_id` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '顧問編號',
  `app_id` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '應用程式編號',
  ...
  PRIMARY KEY (`ib_id`,`com_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='顧問擁有的應用程式';

                        ...
                        <table id="myTable" class="cell-border display nowrap dataTable dtr-inline table_style" cellspacing="0" width="" role="grid" aria-describedby="example_info" style="width: 100%;">
                            ...
                            <tbody>
                                <tr role="row" class="odd parent">
                                    ...
                                    <td>
                                        <div class="btn_Position">
                                            <a class="btn btn-danger btn_sm_Width Gradient_Blue" id="BTN_Check" href="/mt4/withdraw_check">審核</a>
                                        </div>
                                    </td>                                   
                                </tr>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                    	<div class="btn_Position">
                                            <a class="btn btn-info btn_sm_Width Gradient_Orange" id="BTN_Examination" href="/mt4/withdraw_check">檢查</a>
                                        </div>
                                    </td>                                  
                                </tr>
                                <tr role="row" class="even">
...
<div class="footer">
	<div class="footer-class">
		<p>Copyright &copy; 2016 <a href="/mt4/withdraw_check">GALLOP Studio</a>. All rights reserved.</p>
	</div>
</div>
<!--footer end-->

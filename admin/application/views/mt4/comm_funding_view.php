...
<body>
    ...
    <div class="content content_BG">
       <div class="container">
           ...
           <div class="wrapper">
            ...
            <div class="contentGroup">
                <form id="commission_Deposit_form" action="" method="post"> 
                    <!--文字start-->
                           ...
                           <tr>
                              ...
                              <td class="vertical_Align">
                               <label class="margin_Right">
                                <input type="radio" name="radio-1" checked="">銀行匯款												
                            </label>
                            <label class="margin_Right">
                                <input type="radio" name="radio-1">信用卡												
                            </label>
                        </td>
                    </tr>											
                    <tr>
            ...
            <tr>
                <td class="txtC vertical_Align">*存入金額</td>
                <td class="vertical_Align">
       ...
       <tr>
          <td class="txtC vertical_Align">*幣別</td>
          <td class="vertical_Align">
           <input class="form-control form_control_style btn_Margin" name="" id="" data-validate="required" placeholder="">
       </td>
   </tr>											
   <tr>
      <td class="txtC vertical_Align" style="word-wrap: break-word; min-width: 100px;">*Debit Bank Name</td>
      <td class="vertical_Align">
       <input class="form-control form_control_style btn_Margin" name="" id="" data-validate="required" placeholder="">                                      	
   </td>
</tr>
<tr>
    <td class="txtC vertical_Align" style="word-wrap: break-word; min-width: 100px;">*Debit Account Name</td>
    <td class="vertical_Align">
       <input class="form-control form_control_style btn_Margin" name="" id="" data-validate="required" placeholder="">	
   </td>
</tr>   
<tr>
    <td class="txtC vertical_Align" style="word-wrap: break-word; min-width: 100px;">*Debit Account Number</td>
    <td class="vertical_Align">
       <input class="form-control form_control_style btn_Margin" name="" id="" data-validate="required" placeholder="">
   </td>
</tr> 
<tr>
    <td class="txtC vertical_Align" style="word-wrap: break-word; min-width: 100px;">*Bank Reference no</td>
    <td class="vertical_Align">
       <input class="form-control form_control_style btn_Margin" name="" id="" data-validate="required" placeholder="">	
   </td>
</tr>

...
<body>
    ...
    <div class="content content_BG">
       <div class="container">
           ...
           <div class="wrapper">
            ...
            <div class="contentGroup">
                <form id="ib_Group_Account_form" action="" method="post"> 
                            ...
                            <tbody>                                  
                               <tr>
                                  ...
                                  <td class="vertical_Align">
                                   60000001(Chen,Chih-Ying)
                               </td>
                           </tr>
                           <tr>
                               <td class="txtC vertical_Align">餘額</td>
                               <td class="vertical_Align">392077</td>
                           </tr>											
                           <tr>
                   ...
                   <tr>
                    <td class="txtC vertical_Align">*受款人名稱<br/>(或公司名稱)</td>
                    <td class="vertical_Align">
                       Chen,Chih-Ying
                   </td>
               </tr>
           ...
           <tr>
              <td class="txtC vertical_Align">*受款人地址<br/>(或公司地址)</td>
              <td class="vertical_Align">
               10F,No210,Aikou 3rd St.,Zhubei City,Hsinchu Country 302,Taiwan
           </td>
       </tr>											
       <tr>
          <td class="txtC vertical_Align">*受款銀行</td>
          <td class="vertical_Align">
           CTBC bank                                       	
       </td>
   </tr>
   <tr>
    <td class="txtC vertical_Align">*受款人銀行帳號<br/>(或公司銀行帳號)</td>
    <td class="vertical_Align">
       873511038965	
   </td>
</tr>   
<tr>
    <td class="txtC vertical_Align">*受款銀行地址</td>
    <td class="vertical_Align">
       1F,No210,Aikou 3rd St.,Zhubei City,Hsinchu Country 302,Taiwan	
   </td>
</tr> 
<tr>
    <td class="txtC vertical_Align">國際匯款代碼<br/>Swift code</td>
    <td class="vertical_Align">
       CTBCTWTP	
   </td>
</tr>
...
<tr>
  <td class="txtC vertical_Align">*銀行資料<br/>(如存摺資料)</td>
  <td class="vertical_Align">
   <span class="btn btn-info btn-sm btn_Shadow disLine_Block" id="">預覽</span>
</td>
</tr>
<tr>
  <td class="txtC vertical_Align">管理者附註</td>
  <td class="vertical_Align">
   <textarea name="" id="" style="width:100%;min-height:80px;"></textarea>	
</td>
</tr>
<tr>

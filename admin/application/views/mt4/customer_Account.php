            ...
            <div class="contentGroup">
                ...
                <div class="txt_Group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <!--下拉選單 SelectBoxIt end---->
                        <!----輸入框 start---->
                        <div class="col-sm-4">
                            <div class="form-group formGroup_Style">
                                <label class="control-label" for="full_name"></label>
                                <input class="form-control form_control_style Blue_Box_Blur" name="customer_Account_name" id="customer_Account_name" data-validate="required" placeholder="帳號姓名" />
                            </div>
                        </div>
                        <!----輸入框 end----->
                        ...
                        <div class="btn_Position disLine_Block">
                            <button class="btn btn-success btn_Width Gradient_Green" id="Search">搜尋</button>
                        </div>
                        <!--搜尋button end---->
                        <div class="clr"></div>
                </div>    
                        ...
                        <table id="myTable" class="cell-border display nowrap dataTable dtr-inline table_style" cellspacing="0" width="" role="grid" aria-describedby="example_info" style="width: 100%;">
                            <thead>
                                <tr role="row" class="BG_Gray">
                                    <th id="Applicant_Account" class="sorting sorting_NONE Color_Gray" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="" style="width: 136px;">申請人帳號</th>
                                    <th id="Name" class="sorting_asc sorting_asc_NONE Color_Gray" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="" style="width: 216px;" aria-sort="ascending">姓名</th>
                                    <th id="Agents_Account" class="sorting sorting_NONE Color_Gray" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="" style="width: 102px;">代理商帳號</th>
                                    <th id="Country" class="dt-body-right sorting sorting_NONE Color_Gray" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="" style="width: 42px;">國家</th>
                                    <th id="Status" class="sorting sorting_NONE Color_Gray" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="" style="width: 92px;">狀態 </th>
                                    <th id="Feature" class="dt-body-right sorting sorting_NONE Color_Gray" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="" style="width: 79px;">功能</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr role="row" class="odd parent">
                                    <td class="txt_Bold">3210695</td>
                                    <td class="sorting_1 txt_Weight">范小小</td>
                                    <td>10100001</td>
                                    <td class="sorting_1">台灣</td>
                                    <td><span class="txt_Check">待審核</span></td>
                                    <td class=" dt-body-right sorting_1">
                                        <div class="btn-group btn-group-justified btn_Width">					
                                            <a type="button" class="btn btn-success bg-lg Gradient_Blue" href="#">查看資料</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr role="row" class="even">
                                    <td class="">5110012</td>
                                    <td class="sorting_1 txt_Weight">王大明</td>
                                    <td>1000031</td>
                                    <td class="sorting_1">台灣</td>
                                    <td>通過</td>
                                    <td class=" dt-body-right sorting_1">
                                ...
                                <tr role="row" class="odd">
                                    <td class="">3210684</td>
                                    <td class="sorting_1 txt_Weight">林小華</td>
                                    <td>10100001</td>
                                    <td class="sorting_1">中國</td>
                                    <td>通過</td>
                                    <td class=" dt-body-right sorting_1">
                                        <div class="btn-group btn-group-justified btn_Width">					
                                            <a type="button" class="btn btn-success bg-lg Gradient_Blue" href="#">查看資料</a>
                                ...
                                <tr role="row" class="even">
                                    <td class="">3210695</td>
                                    <td class="sorting_1 txt_Weight">林小華</td>
                                    <td>2489000651</td><td class="">台灣</td>
                                    <td>通過</td>
                                ...
                                <tr role="row" class="odd">
                                    <td class="">3210684</td>
                                    <td class="sorting_1 txt_Weight">蔡小婷</td>
                                    <td>1000031</td>
                                    <td class="sorting_1">中國</td>
                                    <td>通過</td>
                                    <td class=" dt-body-right sorting_1">
                                ...
                                <tr role="row" class="even">
                                    <td class="">3210695</td>
                                    <td class="sorting_1 txt_Weight">劉小雯</td>
                                    <td>1000031</td>
                                    <td class="sorting_1">台灣</td>
                                    <td>拒絕</td>
                                    <td class=" dt-body-right sorting_1">

<!-- daterangepicker -->
<!--<script src="<?=ASSETS_JS?>moment.min.js"></script>
<script src="<?=ASSETS_JS?>thirdParty/plugins/daterangepicker/daterangepicker.js"></script>
 iCheck 1.0.1 
<script src="<?=ASSETS_JS?>thirdParty/plugins/iCheck/icheck.min.js"></script>
 bootstrap time picker 
<script src="<?=ASSETS_JS?>thirdParty/plugins/timepicker/bootstrap-timepicker.min.js"></script>
...
<script src="<?=ASSETS_JS?>jquery.cookie.js"></script>-->
...
<script>
    ...
    $('li[id] span, #tree_head').click(function(e){
      ...
      if(ib_id == undefined)
          ...
          location.href = '/mt4/ib_list?ib_id=' + ib_id;
  });

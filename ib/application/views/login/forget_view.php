    ...
    <div class="login-box-body">
        ...
        echo form_open('forget_confirm', $attrs) ?>
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control input-lg" name="account" placeholder="<?=$this->lang->line('ph1')?>">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <h3>E-mail信箱:</h3>
            <div class="form-group has-feedback">
                <input type="email" class="form-control input-lg" name="email" placeholder="<?=$this->lang->line('ph4')?>">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <h3>驗證碼:</h3>
            <div class="form-group has-feedback">
                <input type="number" class="form-control input-lg" name="code" placeholder="<?=$this->lang->line('ph3')?>">

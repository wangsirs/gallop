...
$(document).ready(function() {
    $('.change_mt4_pw').click(function() {
        ...
        $.ajax({
            url: '/grants/change_mt4_pw?is_ajax=1',
            type: 'POST',
            dataType: 'json',
...
<div class="content-wrapper">
    <div class="container container-v-center">
        ...
        <section class="content">
            <form class="change_pw" action="/grants/change_pw_conf" method="post" novalidate="novalidate">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <option value="0" selected>請選擇</option>                                          
                                        ...
                                        <option value="<?=$mt4['mt4_id']?>"><?=$mt4['mt4_id']?> <?=empty($mt4['note']) ? '' : '('.$mt4['note'].')'?></option>
                                        <?php endforeach;} ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    <button type="button" class="btn btn-danger  change_mt4_pw"><span class="glyphicon glyphicon-lock"></span>&nbsp;忘記MT4密碼</button>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <h5 class="text-blue"><span class="glyphicon glyphicon-info-sign"></span>按下後，MT4觀看密碼改為登入密碼＋出生日期四碼</h5>
                                </div>
                            </div>
                        </div>
                    </div>

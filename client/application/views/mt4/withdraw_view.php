      ...
      submitHandler: function(formElem) {
         ...
         $.ajax({
            ...
            success: function(resp) {
               ...
               if (resp.status === true) {
                  location.href = '/mt4/withdraw_otp';
               } else {
...
<div class="content-wrapper">
   <div class="container container-v-center">
      ...
      <section class="content">
         <form class="form-horizontal withdraw" action="/mt4/withdraw" method="post" novalidate="novalidate">
            <div class="box box-primary">
               ...
               <div class="box-body">
                  ...
                  <div class="form-group">
                     <label for="" class="col-sm-2 control-label">提取金額</label>
                     <div class="col-sm-10">
